...
import { Text ,View,TouchableOpacity,ActivityIndicator,Alert,ScrollView,Keyboard,Dimensions,KeyboardAvoidingView,TouchableWithoutFeedback,Image,ImageBackground,TextInput} from 'react-native'
...
export default class Signup extends Component{
    ...
    registerUser = () => {
        if(this.state.email === '' || this.state.pass === '' || this.state.name === '' || this.state.phone === '' || this.state.enrol === '' ) {
        ...
        // dbRef = firebase.firestore().collection('user');
          ...
          firebase.firestore().collection('studentsData')
          .doc(this.state.enrol)
          .set({
      ...
      //   firebase.database().ref("attedance/"+x+"/").set({
      //     ada:Math.floor(Math.random() * 25) + 75,
      //     cn:Math.floor(Math.random() * 25) + 75,
      //     cpd:Math.floor(Math.random() * 25) + 75,
      //     de:Math.floor(Math.random() * 25) + 75,
      //     pds:Math.floor(Math.random() * 25) + 75,
      //     pe:Math.floor(Math.random() * 25) + 75,
      //     se:Math.floor(Math.random() * 25) + 75

      // })

          // firebase.database().ref().child('/user/1233')
            ...
            <View style={{}}>
                ...
                <ImageBackground
                    source={require('../images/back.jpg')}
                        ...
                        style={{height: 200,alignSelf:'center',marginBottom:-50,width: 200,resizeMode: 'stretch',borderRadius:150}}/>
